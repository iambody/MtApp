...
import io.vtown.WuMaiApp.ui.ALoad;
...
public class DownloadService extends Service {
	...
	private static final String saveFileName  = savePath + "mtai.apk";
...
//							"文件已下载完毕", "");
			...
			case 3:
				...
				Intent intent = new Intent(getApplicationContext(), ANewHome.class);
	...
	private void setUpNotification() {
		...
		RemoteViews contentView = new RemoteViews(getPackageName(),
				R.layout.update_download_notification_layout);
		contentView.setTextViewText(R.id.tv_progress, notify_name);
		// 指定个性化视图
		mNotification.contentView = contentView;

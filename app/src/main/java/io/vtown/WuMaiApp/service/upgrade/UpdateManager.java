package io.vtown.WuMaiApp.service.upgrade;
...
public class UpdateManager {
	...
	private static final String savePath = "/sdcard/updatewtapk/"; // apk保存到SD卡的路径
	private static final String saveFileName = savePath + "maitai.apk"; // 完整路径名
